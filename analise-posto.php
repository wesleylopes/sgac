...
$sql="SELECT DISTINCT(NOME_POSTO) AS NOME_POSTO FROM movimento_veiculos WHERE DATE(DATA_MOVIMENTO) between '$dti' and '$dtf'"; 
 echo $sql; 
$sql = $db->query($sql);            
...
foreach ($registros as $registro){
  ...
  $arrayGasolinaConsolidado[]   = buscaValorQtCombPostoConsolidado($dti,$dtf,'GASOLINA', $posto);
  $arrayEtanolConsolidado[]     = buscaValorQtCombPostoConsolidado($dti,$dtf,'ETANOL', $posto);
  $arrayDieselConsolidado[]     = buscaValorQtCombPostoConsolidado($dti,$dtf,'DIESEL', $posto); 
}  
