          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="breadcrumb-holder">
                <h1 class="main-title float-left"> <i class="fa fa-fw fa-user"></i> &nbsp;USUÁRIOS </h1>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                <div class="pull-left">
                  ...
                  <button type="submit" class="btn btn-primary btn-sm  btn-block" data-toggle="modal" data-target="#myModalcad"><i class="fa fa fa-plus-circle"></i> INSERIR USUÁRIO</button>
                </div>
              </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title text-center" id="myModalLabel">Cadastro de Usuário</h4>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input name="nome" type="password" class="form-control">
                        </div>
                      </div>
                  </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3">
              <div class="card-header">
                <i class="fa fa-table"></i> CADASTRE AQUI TODOS OS USUÁRIOS QUE TERÃO ACESSO AO SISTEM.
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="example1" class="table table-bordered table-hover display">
                    ...
                    <tbody>
                      <?php foreach ($regUsuarios as $usuario){ ?>
                      <tr>
