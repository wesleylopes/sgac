...
if (!empty($_FILES['excel']['tmp_name'])) {
    ...
    if (!$objWorksheet->getCellByColumnAndRow(0, 1)->getValue()=='' &&
        ...
        $objWorksheet->getCellByColumnAndRow(1, 1)->getValue()=='Número Cartão' &&
        !$objWorksheet->getCellByColumnAndRow(2, 1)->getValue()=='' &&
        $objWorksheet->getCellByColumnAndRow(2, 1)->getValue()=='Data' &&
        !$objWorksheet->getCellByColumnAndRow(3, 1)->getValue()=='' &&
        $objWorksheet->getCellByColumnAndRow(3, 1)->getValue()=='Matrícula' &&
        !$objWorksheet->getCellByColumnAndRow(4, 1)->getValue()=='' &&
        $objWorksheet->getCellByColumnAndRow(4, 1)->getValue()=='Motorista'){
    ...
    for ($row = 2; $row <= $highestRow; ++$row) {        
       ...
       echo "Arquivo de importação de Histórico de Abastecimentos Invalido!";
       echo "<br>";
       echo " <a href='#' onclick= 'javascript:history.back(-1);'> Voltar</a>";
    }
