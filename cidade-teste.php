...
function agrupaArray($array) {
 ...
 $arrayAgrupado = agrupaArray($arrayValorDieselAgrupado,$arrayQuantidadeDieselAgrupado); 
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                      ...
                      <br>
                      <?php
                     // print_r(agrupaArray($arrayValorDieselAgrupado,$arrayQuantidadeDieselAgrupado)); 
                     echo "<br>";
                     // echo montaGraficoQuantidade(agrupaArray($arrayValorDieselAgrupado,$arrayQuantidadeDieselAgrupado));
                       ?>
                      </pre>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              onComplete: function() {
                ...
                this.data.datasets.forEach(function(dataset, i) {
                  ...
                  meta.data.forEach(function(bar, index) {
                    ...
                    ctx.fillText(data2, bar._model.x + 20, bar._model.y);
                  });
                });
              },
            },
      ...
      <script>
        ...
        var barChart = new Chart(ctx1, {
          ...
          data: {
            ...
            datasets: [{
              label: 'CIDADE X PREÇO MÉDIO COMBUSTÍVELss',
