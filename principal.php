        ...
        <div class="left main-sidebar">
            ...
            <div class="sidebar-inner leftscroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        <li class="submenu">
                            <a class="active1" href="index.php"><i class="fa fa-fw fa-tachometer"></i><span> Dashboard Principal </span> </a>
                            <a class="active2" href="index.php"><i class="fa fa-fw fa-bar-chart"></i><span> Preço Médio por Posto </span> </a>
                            <a class="active2" href="index.php"><i class="fa fa-fw fa-line-chart"></i><span> Evolução de Preço </span> </a>
