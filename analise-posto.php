                            ...
                            if($sql->rowCount() >0){
                                ...
                                foreach ($registros as $registro){
                                    ...
                                    $arrayGasolinaConsolidado[]   = buscaValorQtCombPostoConsolidado(
                                        $dti,$dtf,'GASOLINA',$cidadeCheck,$poloCheck,$equipeCheck,$veiculoCheck,$posto,$tipoCombustivelCheck, $tipoVeiculoCheck, $modeloVeiculoCheck
                                    );

                                    $arrayEtanolConsolidado[]   = buscaValorQtCombPostoConsolidado(
                                        $dti,$dtf,'ETANOL',$cidadeCheck,$poloCheck,$equipeCheck,$veiculoCheck,$posto,$tipoCombustivelCheck, $tipoVeiculoCheck, $modeloVeiculoCheck
                                    );

                                    $arrayDieselConsolidado[]= buscaValorQtCombPostoConsolidado(
                                        $dti,$dtf,'DIESEL',$cidadeCheck,$poloCheck,$equipeCheck,$veiculoCheck,$posto,$tipoCombustivelCheck, $tipoVeiculoCheck, $modeloVeiculoCheck
                                    );
                                } 
                            }                                
