CREATE DEFINER=`root`@`localhost` PROCEDURE `buscaPrecoQtdCidadeConsolidado`(IN `p_tipoCombustivel` VARCHAR(70) CHARACTER SET utf8mb4, IN `p_dataInicial` VARCHAR(70) CHARACTER SET utf8mb4, IN `p_dataFinal` VARCHAR(70) CHARACTER SET utf8mb4, IN `p_cidade` VARCHAR(70) CHARACTER SET utf8mb4)
BEGIN
