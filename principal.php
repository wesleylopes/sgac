...
<body class="adminbody">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="card-box noradius noborder bg-warning">
                                ...
                                <button class="btn botao-painel float-right"><a class="text-white" href="detalhe.php?busca=veiculos&dti=<?php echo $_POST['datai']?>&dtf=<?php echo $_POST['dataf']?>&tipoerro=transacoes">+</a></button>
                                ...
                                <hr>    
                                <span class="text-white">Equipamentos Ativos</span>
                                <button class="btn botao-painel float-right"><a class="text-white" href="detalhe.php?busca=transacoes&dti=<?php echo $_POST['datai']?>&dtf=<?php echo $_POST['dataf']?>&tipoerro=transacoes">+</a></button>
                                <h4 class="m-b-20 text-white counter"><?php echo $qtdVeiculosAtivos ?></h4>
                                
                                <span class="text-white">Equipamentos em Atividade</span>
                                <button class="btn botao-painel float-right"><a class="text-white" href="detalhe.php?busca=transacoes&dti=<?php echo $_POST['datai']?>&dtf=<?php echo $_POST['dataf']?>&tipoerro=transacoes">+</a></button>
                                <h4 class="m-b-20 text-white counter"><?php echo $qtdVeiculosAtivos ?></h4>
    ...
    $sql= "SELECT  
                                ...
                                <button class="btn botao-painel float-right btn-link"><a href="detalhe.php?busca=abastecimento&dti=<?php echo $_POST['datai']?>&dtf=<?php echo $_POST['dataf']?>">Ver Mais..</a></button>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                ...
                                <button class="btn botao-painel float-right btn-link"><a href="detalhe.php?busca=condutores&dti=<?php echo $_POST['datai']?>&dtf=<?php echo $_POST['dataf']?>">Ver Mais..</a></button>
                                <div class="card-footer small text-muted">Atualizado Hoje</div>
                            </div><!-- end card-->
                        </div>
                    </div>
