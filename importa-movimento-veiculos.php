            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-12">
              ...
              <div class="card mb-3">
                <div class="card-header">
                  <i class="fa fa-upload"></i> Selecione o Arquivo (lstAnaliseConsumoCombustivel.xls) para upload e clique no botão "Enviar" para atualizar a base de Dados.

                  <form class="form-group" method="POST" action="upload-mov-veiculos.php" enctype="multipart/form-data">
                    <br />
