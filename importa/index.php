        ...
        <div id="sidebar-menu">
          <ul>
            <li class="submenu1">
              ...
              <a class="active2" href="#"><i class="fa fa-fw fa-bar-chart"></i><span> Preço Médio por Posto </span></a>
              <a class="active2" href="../evolucao-preco.php"><i class="fa fa-fw fa-line-chart"></i><span> Evolução de Preço </span></a>
              <a class="active"  href="/importa/index.php"><i class="fa fa-fw fa-cloud-upload"></i><span> Upload de arquivos (Excel) </span></a>
            </li>
