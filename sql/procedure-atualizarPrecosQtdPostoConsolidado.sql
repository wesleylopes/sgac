DROP PROCEDURE `buscaPrecoQtdPostoConsolidado`;
DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `buscaPrecoQtdPostoConsolidado`(
   IN p_tipoCombustivel VARCHAR(70) CHARACTER SET utf8mb4,
   IN p_dataInicial VARCHAR(70) CHARACTER SET utf8mb4,
   IN p_dataFinal VARCHAR(70) CHARACTER SET utf8mb4 ,
   IN p_posto VARCHAR(70) CHARACTER SET utf8mb4 )
BEGIN
...
-- Abertura do cursor
  ...
  FETCH cursorMovimentoVeiculos INTO  v_nomePosto,
                                      v_valorUnitario,
                                      v_quantidade, 
                                      v_data_movimento, 
                                      v_centroResultado,
  ...
  SELECT 
    ...
    UPPER( v_nomePosto) AS NOME_POSTO,
